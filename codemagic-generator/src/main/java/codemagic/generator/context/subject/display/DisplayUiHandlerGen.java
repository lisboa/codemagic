 ...
 *
 */
public class DisplayUiHandlerGen {

	private final DisplayContext displayContext;
	
	
	public DisplayUiHandlerGen(final IContext ctx) {
	...
	public void generate() throws IOException {
		...
		// input
		final String viewJava = ClassLoadUtil.loadFile(DisplayUiHandlerGen.class, "templates/display/_EntityName_UiHandlers.java.template");
		...
		final String fullName = displayContext.buildArtifactFullFileName( ArtefactyType.UI_HANDLER );
