...
public class NavEventGen {

	private final NavContext navContext;
	
	
	public NavEventGen(final IContext ctx) {
	...
	public void generate() throws IOException {
		...
		// input
		final String viewJava = ClassLoadUtil.loadFile(NavEventGen.class, "templates/nav/_BaseObjectName_Event.java.template");
		...
		final String fullName = navContext.buildArtifactFullFileName( ArtefactyType.EVENT );
