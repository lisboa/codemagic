...
public class NavModuleGen {

	private final NavContext navContext;
	
	
	public NavModuleGen(final IContext ctx) {
	...
	public void generate() throws IOException {
		...
		// input
		final String viewJava = ClassLoadUtil.loadFile(NavModuleGen.class, "templates/nav/_BaseObjectName_NavModule.java.template");
		...
		final String fullName = navContext.buildArtifactFullFileName( ArtefactyType.MODULE );
