...
public class MessageGen {
	...
	public MessageGen(final IContext ctx) {
	...
	public void generate() throws IOException {
		...
		// input
		final String viewJava = ClassLoadUtil.loadFile(MessageGen.class, "templates/type/_BaseObjectName_Messages.java.template");
		...
		final String fullName = typeContext.buildArtifactFullFileName( ArtefactyType.MESSAGES );
