...
public class DataGridTableUiHandlerGen {

	private final SubContext tableSubContext;
	
	public DataGridTableUiHandlerGen(final IContext ctx) {
	...
	public void generate() throws IOException {
		...
		// input
		final String template = ClassLoadUtil.loadFile(DataGridTableUiHandlerGen.class, "templates/datagrid/withasynprovider/table/_BaseObjectName_UiHandlers.java.template");
		...
		final String fullName = tableSubContext.buildArtifactFullFileName( ArtefactyType.UI_HANDLER );
